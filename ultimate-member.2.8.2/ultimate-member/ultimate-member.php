<?php
/**
 * Plugin Name: Ultimate Member [DO NOT UPDATE]
 * Plugin URI: http://ultimatemember.com/
 * Description: -STAY ON THIS VERSION. Any update will cause WP to stop working- The easiest way to create powerful online communities and beautiful user profiles with WordPress
 * Version: 2.8.2
